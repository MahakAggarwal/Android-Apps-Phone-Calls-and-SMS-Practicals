package me.mahakagg.phonecallingsamplecc;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void callNumber(View view) {
        ...
        normalizedNumber = PhoneNumberUtils.normalizeNumber(editText.getText().toString());
        String phoneNumber = String.format("tel: %s", normalizedNumber);
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            ...
            switch (state) {
                case TelephonyManager.CALL_STATE_RINGING:
                    TextView incomingView = findViewById(R.id.incoming_number);
                    incomingView.setText(getString(R.string.incoming_call_from) + " " + incomingNumber);
